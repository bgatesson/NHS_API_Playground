...
def send_api_request():
    ...
    first_api_url = "https://int.api.service.nhs.uk/summary-care-record/FHIR/R4/DocumentReference?patient=https%3A%2F%2Ffhir.nhs.uk%2FId%2Fnhs-number%7C7241596323&type=http%3A%2F%2Fsnomed.info%2Fsct%7C196981000000101&_sort=date&_count=1"

    # Headers for the first API request
    headers = {
        "authorization": "Bearer kiQlkVGWp07cnYwbj9CyYmG1LlwA",
    ...
    if composition_identifier:
        ...
        second_api_url = f"https://int.api.service.nhs.uk/summary-care-record/FHIR/R4/Bundle?composition.identifier={composition_identifier}&composition.subject%3APatient.identifier=https%3A%2F%2Ffhir.nhs.uk%2FId%2Fnhs-number%7C7241596323"
